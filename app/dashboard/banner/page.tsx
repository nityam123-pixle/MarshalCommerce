        ...
        <>
            <div className="flex items-center justify-end">
                <Button asChild className="flex gap-x-2">
                    <Link href="/dashboard/banner/create"><PlusCircle className="size-5" />
                    ...
                    <Table>
                        ...
                        <TableBody>
                            {data.map((item)=>(
                                ...
                                <TableCell>
                                    <Image alt="Banner Picture" src={item.imageString} width={64} height={64} className="rounded-lg object-cover size-16" />
                                </TableCell>
